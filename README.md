...
## About Timesketch
Timesketch is an open source tool for collaborative forensic timeline analysis. Collaborators can simultaneously organize and analyze timelines. Raw data can be enriched with annotations, comments, tags, and stars.
